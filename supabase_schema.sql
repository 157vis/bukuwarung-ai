-- =============================================================================
-- laris.AI / BukuWarung-AI — Multi-Tenant schema (Supabase SQL Editor)
-- Copy-paste seluruh file ini ke Supabase → SQL → New query → Run
-- =============================================================================
...
-- ---------------------------------------------------------------------------
-- Row Level Security — tenant hanya akses baris milik sendiri (auth.uid())
-- Backend webhook memakai service_role → bypass RLS otomatis.
-- ---------------------------------------------------------------------------
